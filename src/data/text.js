...
export const text = [
  ...
  generatePortfolioItem(
    "Nike x Champs Sports — WATCH HER GLOW",
  ...
  generatePortfolioItem(
    "Edible Apartment — Stories of The Future Hackathon 2018 Overall Winner",
  ...
  generatePortfolioItem(
    "SeeReal — Hack@Brown 2018 Winner Most Innovative",
  ...
  generatePortfolioItem(
    "SommailAR — Hack@Brown 2017 Winner Best UX",
